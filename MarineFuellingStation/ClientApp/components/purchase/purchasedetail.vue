<template>
    <div id="root">
        <div v-show="model.state < 7" style="background-color: yellowgreen;padding: 10px; text-align: center; color: white">施工中，未完工</div>
        <div v-show="model.state == 7" style="background-color: yellowgreen;padding: 10px; text-align: center; color: white">卸油完工，待审核</div>
