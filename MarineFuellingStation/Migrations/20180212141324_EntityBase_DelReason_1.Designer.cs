...
namespace MFS.Migrations
{
    ...
    [Migration("20180212141324_EntityBase_DelReason_1")]
    partial class EntityBase_DelReason_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MFS.Models.Assay", b =>
                {
                    ...
                    b.Property<DateTime>("OilTempTime");
                    ...
                    b.Property<decimal>("凝点");

                    b.Property<decimal>("初硫");

                    b.Property<string>("十六烷值");

                    b.Property<string>("十六烷指数");

                    b.Property<decimal>("含硫");

                    b.Property<decimal>("回流");

                    b.Property<decimal>("干点");

                    b.Property<double>("标密");

                    b.Property<string>("混水反应");

                    b.Property<decimal>("蚀点");

                    b.Property<double>("视密");
            ...
            modelBuilder.Entity("MFS.Models.ChargeLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MFS.Models.MoveStore", b =>
                {
                    ...
                    b.Property<string>("OutStoreName");
            ...
            modelBuilder.Entity("MFS.Models.Notice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MFS.Models.Order", b =>
                {
                    ...
                    b.Property<decimal>("BillingCount");
                    ...
                    b.Property<decimal>("OilCountLitre");
            ...
            modelBuilder.Entity("MFS.Models.Product", b =>
                {
                    ...
                    b.Property<decimal>("MinInvoicePrice");
            ...
            modelBuilder.Entity("MFS.Models.Purchase", b =>
                {
                    ...
                    b.Property<decimal>("ScaleWithCar");
                    ...
                    b.Property<string>("ToStoreInstruAf");

                    b.Property<string>("ToStoreInstruBf");
            ...
            modelBuilder.Entity("MFS.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<DateTime>("ReportDutyTime");
            ...
            modelBuilder.Entity("MFS.Models.Wage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<decimal>("交通");

                    b.Property<decimal>("借支");

                    b.Property<decimal>("出勤天数");

                    b.Property<decimal>("基本");

                    b.Property<decimal>("安全保障金");

                    b.Property<decimal>("实发");

                    b.Property<int>("年月");

                    b.Property<decimal>("应付");

                    b.Property<decimal>("提成");

                    b.Property<decimal>("现金");

                    b.Property<decimal>("社保");

                    b.Property<decimal>("绩效工资");

                    b.Property<string>("职务");

                    b.Property<decimal>("请假");

                    b.Property<decimal>("超额");

                    b.Property<decimal>("转卡金额");

                    b.Property<decimal>("餐费");
            ...
            modelBuilder.Entity("MFS.Models.Payment", b =>
                {
                    b.HasOne("MFS.Models.BoatClean", "BoatClean")
                        .WithMany("Payments")
                        .HasForeignKey("BoatCleanId");
